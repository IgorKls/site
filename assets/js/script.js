// проверка на поддержку браузером картинок формата "webp"
// проверка на поддержку браузером картинок формата "webp"
...
menuToggle.addEventListener('click', function (event) {
    ...
    aside_right.classList.toggle('visible');
    aside_left.classList.toggle('visible');
    menuToggle.classList.toggle('active');
});

// adaptive sidebar height
$(document).ready(function () {
    let h = $('.header').css('height');
    let ha = $('.aside').css('top', h);
});
...
let animItems = document.querySelectorAll('.animation-text');
